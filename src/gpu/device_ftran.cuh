 ...
 */
inline __device__ void device_ftran(const DeviceSparseLU& lu, const WorkingBasisState& ws, Float* vec) {
    Float* w = ws.aux_vec;
...
inline __device__ void device_btran(const DeviceSparseLU& lu, const WorkingBasisState& ws, Float* vec) {
    Float* w = ws.aux_vec;
...
inline __device__ bool device_update_basis(
